...
namespace Hannon.FreightEngine.Models
{
    [Serializable()]
    public class Address
    {
        ...
        {
            return $"{nameof(ID)}: {ID}, {nameof(FirmName)}: {FirmName}, {nameof(Contact)}: {Contact}, {nameof(ContactEmail)}: {ContactEmail}, {nameof(Address1)}: {Address1}, {nameof(Address2)}: {Address2}, {nameof(City)}: {City}, {nameof(State)}: {State}, {nameof(Zip)}: {Zip}, {nameof(ZipPlus4)}: {ZipPlus4}";
        }
